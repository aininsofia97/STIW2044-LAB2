...
import 'package:share_loving/loginscreen.dart';
...
class _RegisterScreenState extends State<RegisterScreen> {
    ...
    return Scaffold(
      ...
      body: Container(
          ...
          children: [
            ...
            Text(
              'I agree to the Terms and Conditions', style: TextStyle(fontSize: 16),
  ...
  void _onRegister() async {
    ...
    await pr.show();
    http.post("http://amongusss.com/ShareLoving/php/register_user.php",
        body: {
          "name": _name,
          "email": _email,
          "password": _password,
...
showAlertDialog(BuildContext context) {
  ...
  AlertDialog alert = AlertDialog(
    ...
    content: Text("Are you sure want to register new account?"),
    actions: [
      cancelButton,
      continueButton,
    ],
